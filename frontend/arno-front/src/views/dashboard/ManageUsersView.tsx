...
import {
  ...
  ManageUsersTab1Steps, ManageUsersTab2Steps, ManageUsersTab3Steps
...
const ManageUsersView = () => {
      ...
      <>
        ...
        <Tabs defaultValue="view">
          <Tabs.List>
            <Tabs.Tab onClick={() => {
              setActiveTab(0)
            }} value="view" icon={<Eye size={14}/>} color="teal">
              مشاهده و جست‌وجو
            </Tabs.Tab>
            <Tabs.Tab onClick={() => {
              setActiveTab(1)
            }} value="edit" icon={<Checklist size={14}/>} color="green">
              متخصصین در انتظار تایید
            </Tabs.Tab>
            <Tabs.Tab onClick={() => {
              setActiveTab(2)
            }} value="new" icon={<Plus size={14}/>} color="blue">
  ...
  function specialistValidationComponent() {
    return (
        <Table striped highlightOnHover className="tour-manage-users-specialist-validation-table">
          <thead>
          <tr>
            <th>نام متخصص</th>
            ...
            if (user.role === UserRole.Specialist && !user.isValidated)
              return (
                  <tr key={user.id}>
                    ...
                    <td>
                      <ActionIcon className={"tour-manage-users-specialist-validation-table-download-document-" + idx}
                    ...
                    <td>
                      <div style={{display: "flex"}}>
                        <ActionIcon
                            className={"tour-manage-users-specialist-validation-table-validate-" + idx}
                            onClick={() => {
  ...
  function userTableComponent() {
    return (
        <>
          <Table striped highlightOnHover verticalSpacing="sm" mt="sm" className="tour-manage-users-user-table">
            <thead>
            <tr>
              <th>نام کاربری</th>
              <th>نام</th>
